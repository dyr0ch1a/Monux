...
use monux_core::index::{note_path_with_dir, parse_tags_input,
path_key};
...
pub fn run(name: Option<String>, tags: Option<String>, dir:
Option<String>) -> anyhow::Result<()> {
    ...
    let parsed_tags = tags.map(|v|
parse_tags_input(&v)).unwrap_or_default();
